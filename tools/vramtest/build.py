#!/usr/bin/env python3
"""Build vramtest.d88: assemble the IPL and the program with ASL and write a
...
def main():
    out = Path(sys.argv[1]) if len(sys.argv) > 1 else HERE / "vramtest.d88"
    ...
    out.write_bytes(d88_image("VRAMTEST", payload))
