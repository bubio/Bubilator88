...
## Key Files
- docs/develop/REGRESSION_CHECK.md — Regression runner usage and workflow
- docs/develop/REGRESSION_CHECK_PLAN.md — Per-scenario spec (boot procedure, keys,
  capture timing) that `capture_reference_screenshots.py` encodes
- docs/develop/ROM_SWEEP.md — Broader compatibility sweep (separate tool)
- docs/develop/BOOTTESTER.md — BootTester environment variables reference
- docs/develop/KNOWN_PITFALLS.md — Historical regression patterns
